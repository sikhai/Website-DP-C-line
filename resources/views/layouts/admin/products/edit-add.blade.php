        ...
        <form role="form"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i> {{ __('voyager::product.details') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status">
                                    <option value="PUBLISHED"@if(isset($dataTypeContent->status) && $dataTypeContent->status == 'PUBLISHED') selected="selected"@endif>{{ __('voyager::product.status_published') }}</option>
                                    <option value="DRAFT"@if(isset($dataTypeContent->status) && $dataTypeContent->status == 'DRAFT') selected="selected"@endif>{{ __('voyager::product.status_draft') }}</option>
                                    <option value="PENDING"@if(isset($dataTypeContent->status) && $dataTypeContent->status == 'PENDING') selected="selected"@endif>{{ __('voyager::product.status_pending') }}</option>
                                </select>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="panel panel-bordered panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" name="title" placeholder="SEO Title" value="{{ $dataTypeContent->title ?? '' }}">
                            </div>
                            <div class="form-group">
            ...
            @section('submit-buttons')
                <button type="submit" class="btn btn-primary pull-right">
                    @if($edit){{ __('voyager::product.update') }}@else <i class="icon wb-plus-circle"></i> {{ __('voyager::product.new') }} @endif
                </button>
            @stop
